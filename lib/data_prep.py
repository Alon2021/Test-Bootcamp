...
parser.add_argument('--sub_name', default='./data', type=str, help='subname')
print('here above')
...
if __name__ == "__main__":
    ...
    left_trans_mat = sio.loadmat(args.trans_path+'_Left_fMRI2Grid_192_by_192_NN.mat')['grid_mapping']
    print(f'The shape of the loaded left-transoformation file is: {left_trans_mat.shape}')
    right_trans_mat = sio.loadmat(args.trans_path+'_Right_fMRI2Grid_192_by_192_NN.mat')['grid_mapping']
    print(f'The shape of the loaded right-transoformation file is: {right_trans_mat.shape}')
    
    # Loading Brain Mask
    LeftMask = sio.loadmat(args.trans_path+'_MSE_Mask.mat')['Regular_Grid_Left_Mask']
    RightMask = sio.loadmat(args.trans_path+'_MSE_Mask.mat')['Regular_Grid_Right_Mask']
    print('here in main')
    # Generate the Left and Right Data
    file_path = os.path.join(args.output_path,args.sub_name)
